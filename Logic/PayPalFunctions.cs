/*
* Pre-staged PayPal fucntionality for payment taking. 
* 
* Need to build shopping cart items after user login and
* registration are created. 
* 
*  Ref: https://docs.microsoft.com/en-us/aspnet/web-forms/overview/getting-started/getting-started-with-aspnet-45-web-forms/checkout-and-payment-with-paypal
* 
* 
*/
...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-1hvmm15545271_api1.business.example.com";
    private string APIPassword = "KZ4R45HWYWT4CSYD";
    private string APISignature = "APNGn6i.ME5bhaW8Lri3Gd.JKIcPAofEiJ24g3poC1EvVSZ4vMeIwoLq";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44354/Checkout/CheckoutReview.aspxax";
        ...
        using (FishingTournament02.Logic.ShoppingCartActions myCartOrders = new FishingTournament02.Logic.ShoppingCartActions())
        {
